...
//             const btnList = [
//                 {type: 'change-order', name: '数组总数不变，只是交换顺序'},
//                 {type: 'head-add', name: '数组总数变了，头部添加一个'}, 
//                 { type: 'tail-add', name: '数组总数变了，尾部添加一个'}, 
//                 { type: 'mid-add', name: '数组总数变了，中间添加一个'},
//                 { type: 'head-del', name: '数组总数变了，头部删除一个'},
//                 { type: 'tail-del', name: '数组总数变了，尾部删除一个'},
//                 { type: 'mid-del', name: '数组总数变了，中间删除一个'}
//             ]
//             return (
//                 <div key='wrapper'>
...
//                         </button>
//                     ))}
//                     {array.map(({ id, name }, i) => (<div key={id}>年龄：{name}</div>))}
//                 </div>
//             );
//         }
//     }, {className: 'classComp', key: 'classComp' }
...
const classComp = React.createElement(
    class extends Component {
        ...
        handleClick1 = () => console.log('我是偶数');
        handleClick2 = () => console.log('我是奇数');
        render() {
